...
set "directory=E:\Files\workspace\202306\git-nature-js\#code_copy\js"  REM 実行したいファイルが存在するディレクトリのパス
set "script_directory=E:\Files\workspace\202306\Esprima_jp"  REM main_cp.js スクリプトのディレクトリのパス
