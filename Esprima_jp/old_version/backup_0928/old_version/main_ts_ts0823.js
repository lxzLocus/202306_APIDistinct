  ...
  if(url_logic[0] == true){
    ...
    if(opt_logic[0] == true){
      ...
      if(payload_logic[2] === 1 || payload_logic[2] === 2){
        ...
        /*requestBody*/
        var param = param_initial(url_logic[1], baseJson)
        console.log(param, '\n')
...
/*param*/
function param_initial(json_num, json){
  var json_schema = json.nature_apis.api[json_num].requestBody.content['application/x-www-form-urlencoded'].schema['$ref']
